...
function buildPersonality(tone, personaName) {
    const formalDesc = 'Sophisticated and professional. Clear and efficient communication. Respectful of customer\'s time.';
    const formalEx = 'Example: "Good afternoon. To schedule your appointment efficiently, may I confirm your preferred date and time? I have availability on Tuesday at 10:00 AM or Wednesday at 2:00 PM. Which would work best?"';
    const convDesc = 'Warm and conversational. Natural and friendly. Like helping a friend schedule.';
    const convEx = "Example: \"Sunday doesn't work since we're closed, but how about Tuesday morning at 10? Or Wednesday at 2pm—what works better?\"";
...
function buildResponseStyle(emojiUsage, channel) {
    let s = "";
...
export async function bdcAppointmentBooking(state) {
...
//# sourceMappingURL=bdcAppointmentBooking.js.map